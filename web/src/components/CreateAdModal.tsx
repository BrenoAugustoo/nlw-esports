        ...
        <Dialog.Title className="text-3xl font-black" >Publique um anúncio</Dialog.Title>
          ...
          <form className="mt-8 flex flex-col gap-4" onSubmit={handleCreateAd}>
            ...
            <div className="grid grid-cols-2 gap-6">
              <Input name="yearsPlaying" id="yearsPlaying" type="number" placeholder="Tudo bem ser ZERO" label="Joga há quanto tempo?" />

              <Input name="discord" id="discord" placeholder="Usuário#0000" label="Qual seu discord?" />
            </div>
